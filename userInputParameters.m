...
data_folder_path='./10_31_17_GO_frame_by_frame_opt/'; %_w_SA_multiplier_' num2str(SA_multiplier) '_HW_Multiplier_' num2str(bb_H_W_std_Multiplier) '_WH_LF_' num2str(bb_learning_ratio) '_Q_' num2str(Q) '_R_' num2str(R) '/']; % Where the results are saved
